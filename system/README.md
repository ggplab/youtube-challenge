...
> **2026-07-19 방향 전환**: Discord 봇 아키텍처(아래 계획)는 폐기. 실제 구현은 **카카오톡 오픈채팅방(소통) + 웹페이지(제출·갤러리) + Apps Script 백엔드**로 확정 — 코드·API·배포 절차는 [`plan-backend/README.md`](plan-backend/README.md) 참조.
> 기획안 제출: `/submit` · 기획서: `/plan` · AI 검토는 Gemini → 이메일 회신.
> 아래 내용은 초기 설계 기록으로만 보존한다.
