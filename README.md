...
| 단계 | 기간 | 내용 |
|------|------|------|
| 온보딩 | ~ 07-12 | 모집 확정, Discord 서버 합류 |
| 오프라인 OT | 07-13 주 (평일 저녁 또는 토 07-18) | AI 워크숍 — 아래 참고 |
| 사이클 1 | 07-20 ~ 08-02 | 기획 주에 **유튜브 채널 개설 포함** |
| 사이클 2 | 08-03 ~ 08-16 | |
| 사이클 3 | 08-17 ~ 08-30 | |
| 사이클 4 | 08-31 ~ 09-13 | |
| 사이클 5 | 09-14 ~ 09-27 | |
...
챌린지 시작 전 딱 한 번, 오프라인으로 모여 AI와 함께 채널의 뼈대를 만든다 (평일 저녁 또는 토요일).
...
- **인증·정산·갤러리**: [content-designer-challenge](https://github.com/ggplab/content_designer_challenge) — 20명 · 12주 · 인증 153건 실운영 (Supabase Edge Functions + Discord + Sheets + GitHub Pages)
